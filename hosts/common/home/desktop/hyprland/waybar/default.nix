...
in
{
  programs.waybar = {
    ...
    settings = [ hyprland-waybar-config ];
  };

  home.file.".config/waybar/config.niri".text = builtins.toJSON [ niri-waybar-config ];
